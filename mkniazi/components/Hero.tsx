...
const Hero: React.FC<{}> = () =>{
    return <div className="flex min-h-screen bg-[#ECECEC] flex-col p-3 pt-10">
        ...
        <div className=" pl-3">
            ...
            <p className="text-[16px] text-[#3A3A3A] w-[70%] mt-2 leading-5  ">
                Helping brands to stand out in the digital era. Together we will set the new status quo.
            </p>
        </div>

        <div className="flex mt-6 ml-3 ">
            <Button className="rounded-full w-[90px] h-[27px] text-[8px]">Let’s talk</Button>
            <p className="text-[10px] ml-[60%] mt-2">@2023</p>
        </div>
    </div>;
}
